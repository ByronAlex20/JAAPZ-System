...
/*	boolean validarPerfil() {
		try {
			List<SegPerfil> listaPerfiles;
			listaPerfiles = segPerfilDAO.getValidarPerfil(txtNombre.getText());
	...
	boolean validarDatos() {
		...
		/*	if(validarPerfil() == true) {
				helper.mostrarAlertaAdvertencia("El perfil ya existe!!", Context.getInstance().getStage());
				txtNombre.requestFocus();
				return false;	
			}*/
			return true;
