...
public class SeguridadUsuarioC {
	...
	void llenarDatos(SegUsuario datoSeleccionado){
		try {
			...
			if(datoSeleccionado.getNombres() == null)
				txtNombres.setText("");
			else
				txtNombres.setText(datoSeleccionado.getNombres());

			if(datoSeleccionado.getApellidos() == null)
				txtApellidos.setText("");
			else
				txtApellidos.setText(datoSeleccionado.getApellidos());
